            ...
            <ul className="space-y-2">
                ...
                <li>
                    <Link href="/" className={
                        ...
                        <span className="ml-3 hidden lg:block">Главная</span>
                    </Link>
                </li>
                <li>
                    <Link href="/laundry" className={
                        ...
                        <span className="ml-3 hidden lg:block">Прачечная</span>
                        <>
                ...
                <li>
                    <Link href="/club" className={
                        ...
                        <span className="ml-3 hidden lg:block">Клуб Романтики</span>
                    </Link>
                </li>
                <li>
                    <Link href="/kds" className={
                        ...
                        <span className="flex-1 ml-3 whitespace-nowrap hidden lg:block">Комната для собраний</span>
                    </Link>
                </li>
                <li>
                    <Link href="/meetingroom" className={
                        ...
                        <span className="flex-1 ml-3 whitespace-nowrap hidden lg:block">Переговорная</span>
                    </Link>
                </li>
            </ul>
            <ul className="pt-4 mt-4 space-y-2 border-t border-gray-200 dark:border-gray-700">
                <li>
                    <Link href="/instruments" className={
                        ...
                        <span className="flex-1 ml-3 whitespace-nowrap hidden lg:block">Инструментарий</span>
                        <span
                ...
                <li>
                    <Link href="/vacuumcleaner" className={
                        ...
                        <span className="flex-1 ml-3 whitespace-nowrap hidden lg:block">Пылесос</span>
                        <span
                            className="justify-center items-center hidden lg:inline-flex px-2 ml-3 text-sm font-medium text-gray-800 bg-gray-200 rounded-full dark:bg-gray-700 dark:text-gray-300">Скоро</span>
                    </Link>
                </li>
